...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://text-detector-cf45a-default-rtdb.asia-southeast1.firebasedatabase.app");
        DatabaseReference myRef = database.getReference("test");
//        DatabaseReference reference = myRef.child("name");
        ...
        detectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // detect a text .
                myRef.setValue("van");
//                myRef.child("gracehop").setValue(new User("December 9, 1906", "Grace Hopper"));
//                detectTxt();
            }
        });
